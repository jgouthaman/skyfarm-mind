...
export const Route = createFileRoute("/control-center/aerospawn-design-studio/history")({
  component: History,
});
                ...
                <tr key={p.id} className="border-t border-border/60">
                  ...
                  <td className="px-4 py-2.5">
                    <div className="flex gap-1.5">
                      <Button asChild size="sm" variant="outline" onClick={() => studioActions.select(p.id)}><Link to="/control-center/aerospawn-design-studio/design">Open</Link></Button>
