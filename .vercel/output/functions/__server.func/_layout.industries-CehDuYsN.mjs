...
import { ae as Rocket, l as ArrowRight, J as Sprout, E as Building2, D as Map, _ as Eye, F as FlaskConical, z as GraduationCap } from "./_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl p-6 bg-gradient-primary text-primary-foreground shadow-soft flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm opacity-90", children: "Every vertical shares the same modular autonomous aerial platform, data, and AI stack — engineered once, deployed everywhere." })
        ] }),
