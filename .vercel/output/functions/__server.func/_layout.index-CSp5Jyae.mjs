...
import { h as heroImg } from "./_ssr/router-0mEd4FZW.mjs";
import { j as Satellite, k as ArrowRight, l as Activity, m as ShieldCheck } from "./_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 lg:px-8 grid lg:grid-cols-12 gap-10 items-center relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-primary-foreground bg-primary border border-primary px-3 py-1.5 rounded-full shadow-glow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Satellite, { className: "h-3.5 w-3.5", "aria-hidden": "true" }),
          " Aerospace · Drones · AI"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-5 text-4xl sm:text-5xl lg:text-6xl font-semibold leading-[1.05]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg text-muted-foreground max-w-xl", children: "AI-powered drone systems, custom UAV engineering, and aerial intelligence solutions for agriculture, infrastructure, mapping, surveillance, and industrial applications." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", className: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/solutions", children: [
            "Explore Solutions ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "ml-1 h-4 w-4", "aria-hidden": "true" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", variant: "outline", className: "border-border/80 bg-card/40 backdrop-blur hover:bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: "Partner With Us" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid grid-cols-3 gap-6 max-w-md", children: HERO_STATS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
