  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col rounded-xl bg-card p-4 transition-colors hover:border-foreground/20", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto border-t border-border pt-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex gap-1.5", children: [
        course.slug ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", variant: "outline", className: "h-7 flex-1", style: {
          fontSize: 11
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/learn/${course.slug}`, children: "Preview course" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "h-7 flex-1", style: {
          fontSize: 11
