...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CDIQFp-n.mjs");
...
const manifest = {
  ...
  "465d753133d03fe4e88ed7addb5729df8340d378a9812b383ba8a1aa8b6bce01": {
    ...
    importer: () => import("./seed.functions-Bqo6ttbU.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-0mEd4FZW.mjs").then((n) => n.r),
    import("./start-CDioOS1W.mjs"),
