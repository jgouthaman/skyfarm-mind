...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DAiMjc9W.mjs");
...
const manifest = {
  "06ebb0949d60cbe4346886641841dbf0a16657472de642c1e66ae51421a08a21": {
    functionName: "createMissionHubUser_createServerFn_handler",
    importer: () => import("./admin.functions-Ca0MSfim.mjs")
  },
  "0feebc4179378179b102bef8c9012b24832fd65750fc9eda3d16eb0299f36406": {
    functionName: "askAdvisor_createServerFn_handler",
    importer: () => import("./advisor.functions-D3vkE3o8.mjs")
  },
  "345b684c762a83a593cab36aea1dc6e1e083883ec262e64cbe6562669338e70a": {
    functionName: "updateMissionHubUser_createServerFn_handler",
    importer: () => import("./admin.functions-Ca0MSfim.mjs")
  },
  "465d753133d03fe4e88ed7addb5729df8340d378a9812b383ba8a1aa8b6bce01": {
    functionName: "seedSuperAdmin_createServerFn_handler",
    importer: () => import("./seed.functions-9iRpHi-m.mjs")
  },
  "cfc200084b8041428ecc271b3a84e9bb67a5bbfc0c10774db3a02fccb40897d5": {
    functionName: "checkSuperAdminExists_createServerFn_handler",
    importer: () => import("./seed.functions-9iRpHi-m.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BXzEd6Tz.mjs").then((n) => n.r),
    import("./start-CxNirAzj.mjs"),
