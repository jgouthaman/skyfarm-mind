...
const appCss = "/assets/styles-BVNLGXJw.css";
...
const $$splitComponentImporter$R = () => import("../_layout-GmU2tkxh.mjs");
...
const $$splitComponentImporter$P = () => import("../_layout.index-CIZoaRGV.mjs");
...
const $$splitComponentImporter$J = () => import("./mission-hub.users--rcfg2lj.mjs");
...
const $$splitComponentImporter$u = () => import("./mission-hub.login-CXXjgvdi.mjs");
...
const $$splitComponentImporter$p = () => import("../_layout.technology-DHaupaPA.mjs");
const Route$p = createFileRoute("/_layout/technology")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_layout.solutions-BBae2_oA.mjs");
...
const $$splitComponentImporter$m = () => import("../_layout.learn-JVWzjNVr.mjs");
...
const $$splitComponentImporter$i = () => import("../_layout.contact-Dn_SopOW.mjs");
...
const $$splitComponentImporter$d = () => import("./pilot.missions._id-gMMMe3QL.mjs");
const Route$d = createFileRoute("/pilot/missions/$id")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./mission-hub.verticals._vertical-gj3VxpHZ.mjs");
const Route$c = createFileRoute("/mission-hub/verticals/$vertical")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./mission-hub.torqwings-design-studio.simulation-C8iNxfDL.mjs");
const Route$b = createFileRoute("/mission-hub/torqwings-design-studio/simulation")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component"),
  ssr: false
});
const $$splitComponentImporter$a = () => import("./mission-hub.torqwings-design-studio.requirements-B25jeamI.mjs");
const Route$a = createFileRoute("/mission-hub/torqwings-design-studio/requirements")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./mission-hub.torqwings-design-studio.report-BaZo6E1D.mjs");
const Route$9 = createFileRoute("/mission-hub/torqwings-design-studio/report")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./mission-hub.torqwings-design-studio.new-2tRXE8uf.mjs");
const Route$8 = createFileRoute("/mission-hub/torqwings-design-studio/new")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component"),
  ssr: false
});
const $$splitComponentImporter$7 = () => import("./mission-hub.torqwings-design-studio.history-TxaV-kpH.mjs");
const Route$7 = createFileRoute("/mission-hub/torqwings-design-studio/history")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./mission-hub.torqwings-design-studio.design-rule-BETNj-Th.mjs");
const Route$6 = createFileRoute("/mission-hub/torqwings-design-studio/design-rule")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./mission-hub.torqwings-design-studio.design-BAcdI7A2.mjs");
const Route$5 = createFileRoute("/mission-hub/torqwings-design-studio/design")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./mission-hub.torqwings-design-studio.components-xLWjE48z.mjs");
const Route$4 = createFileRoute("/mission-hub/torqwings-design-studio/components")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./mission-hub.torqwings-design-studio.compliance-CrIvjtgv.mjs");
const Route$3 = createFileRoute("/mission-hub/torqwings-design-studio/compliance")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./mission-hub.torqwings-design-studio.advisor-DyutFla9.mjs");
const Route$2 = createFileRoute("/mission-hub/torqwings-design-studio/advisor")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_layout.learn.drone-design-fundamentals-QB48Kh2S.mjs");
const Route$1 = createFileRoute("/_layout/learn/drone-design-fundamentals")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_layout.auth.callback-Wn-mUI73.mjs");
const Route = createFileRoute("/_layout/auth/callback")({
...
const PilotMissionsIdRoute = Route$d.update({
  id: "/missions/$id",
  path: "/missions/$id",
  getParentRoute: () => PilotRoute
});
const MissionHubVerticalsVerticalRoute = Route$c.update({
  id: "/verticals/$vertical",
  path: "/verticals/$vertical",
  getParentRoute: () => MissionHubRoute
});
const MissionHubTorqwingsDesignStudioSimulationRoute = Route$b.update({
  id: "/simulation",
  path: "/simulation",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioRequirementsRoute = Route$a.update({
  id: "/requirements",
  path: "/requirements",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioReportRoute = Route$9.update({
  id: "/report",
  path: "/report",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioNewRoute = Route$8.update({
  id: "/new",
  path: "/new",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioHistoryRoute = Route$7.update({
  id: "/history",
  path: "/history",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioDesignRuleRoute = Route$6.update({
  id: "/design-rule",
  path: "/design-rule",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioDesignRoute = Route$5.update({
  id: "/design",
  path: "/design",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioComponentsRoute = Route$4.update({
  id: "/components",
  path: "/components",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioComplianceRoute = Route$3.update({
  id: "/compliance",
  path: "/compliance",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const MissionHubTorqwingsDesignStudioAdvisorRoute = Route$2.update({
  id: "/advisor",
  path: "/advisor",
  getParentRoute: () => MissionHubTorqwingsDesignStudioRoute
});
const LayoutLearnDroneDesignFundamentalsRoute = Route$1.update({
  id: "/drone-design-fundamentals",
  path: "/drone-design-fundamentals",
  getParentRoute: () => LayoutLearnRoute
});
const LayoutAuthCallbackRoute = Route.update({
  id: "/auth/callback",
  path: "/auth/callback",
  getParentRoute: () => LayoutRoute
});
