...
import { T as TECH_PIPELINE, P as PRODUCT_CAPABILITIES } from "./_ssr/solutions.constants-Cryr-zEX.mjs";
import { l as ArrowRight } from "./_libs/lucide-react.mjs";
function TechnologyPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { id: "technology", eyebrow: "Technology", title: "A modular autonomous aerial intelligence stack", muted: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-3xl", children: "TorqWings is built as a reusable design and intelligence platform — from mission requirements and platform design through to data capture, AI analysis, and enterprise-grade aerial operations." }),
